...
export namespace Prisma {
  ...
  */
  ...
  export type GenresOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "slug" | "description" | "icon" | "createdAt" | "updatedAt", ExtArgs["result"]["genres"]>
  ...
  interface GenresFieldRefs {
    ...
    readonly description: FieldRef<"Genres", 'String'>
    readonly icon: FieldRef<"Genres", 'String'>
  ...
  export type GenresWhereInput = {
    ...
    description?: StringFilter<"Genres"> | string
    icon?: StringFilter<"Genres"> | string
  ...
  export type GenresScalarWhereWithAggregatesInput = {
    ...
    description?: StringWithAggregatesFilter<"Genres"> | string
    icon?: StringWithAggregatesFilter<"Genres"> | string
